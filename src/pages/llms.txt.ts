...
${SITE.name}은 ${CLINIC.address.addressLocality} 대천동(1호선 진천역 4번 출구 도보 6분, 399m)에 위치한 한의원입니다. ${CLINIC.doctorName} 원장이 통증·교통사고 후유증·다이어트·소아성장·피부미용·체질개선을 진료하며, 추나·약침·골타·매선·근건이완수기요법·한약을 환자 상태에 맞춰 적용합니다. 모든 건강 정보 글은 보건복지부·건강보험심사평가원·대한한의사협회 등 공신력 있는 출처를 인용하고 한의사 명의로 작성됩니다.

...
export const TREATMENT_DETAILS: TreatmentDetail[] = [
  // 01. 근건이완수기요법 (체외충격파)
  {
    ...
    heroImageAlt: '근건이완수기요법을 받는 모습 (팔 부위)',
    intro:
      '오래된 어깨, 팔꿈치, 발바닥 통증이 침이나 약침을 받아도 마지막에 잘 안 풀릴 때가 있습니다. 이럴 때 태림한의원은 체외충격파를 이용한 근건이완수기요법으로, 굳어 있던 근육과 힘줄에 파동 자극을 전해 이완을 돕습니다. 바늘도, 주사도, 절개도 없이 받습니다.',
    whatIsIt: [
      '근건이완수기요법은 굳은 근육과 힘줄을 풀어 주는 한방 치료입니다. 태림한의원은 여기에 체외충격파(몸 밖에서 만든 진동, 파동)를 함께 이용해, 손이 닿기 어려운 깊은 부위까지 자극을 전달합니다. 흔히 충격파라고 부르는 방식이지만, 침, 약침, 추나와 함께 통증 부위의 긴장을 풀고 혈류를 돕는 데 목적이 있습니다.',
    ...
    process: [
      '어디가 언제부터 아픈지 충분히 듣고, 근건이완수기요법이 맞는 상태인지 먼저 봅니다.',
      '통증 부위와 깊이에 맞춰 자극 방식과 강도를 정합니다. 처음에는 약하게 시작합니다.',
      '아픈 지점에 기구를 대고 체외충격파 자극을 전달합니다. 한 부위는 보통 몇 분이면 끝납니다.',
      '받으신 느낌을 보며 강도와 횟수를 조절합니다. 대개 여러 번에 걸쳐 진행합니다.',
    ],
    benefit: [
      '바늘, 주사, 약 없이 짧은 시간에 받을 수 있어, 다른 치료가 부담스러운 분께도 권하기 좋습니다.',
      '오래된 근육, 힘줄 통증의 이완에 도움이 된다고 여러 연구에서 보고되어 있습니다. 다만 효과와 필요한 횟수는 환자분의 상태에 따라 다릅니다.',
    ],
    gallery: [
      { src: '/images/clinic/shockwave-treatment.webp', alt: '근건이완수기요법을 받는 모습 (팔 부위)' },
      { src: '/images/clinic/shockwave-focused.webp', alt: '깊은 부위에 쓰는 체외충격파 기구' },
      { src: '/images/clinic/shockwave-machine.webp', alt: '태림한의원 근건이완수기요법 장비' },
    ],
    faqs: [
      ...
      { q: '보험이 되나요?', a: '근건이완수기요법은 항목과 상황에 따라 다릅니다. 비용은 진료 때 미리 안내드리고, 무리하게 권하지 않습니다.' },
    ],
    related: [
      { label: '근건이완수기요법이 더 궁금하다면 (자세한 설명)', href: '/pain/shockwave-ultra-dual-radial-focused/' },
      { label: '통증치료 전체 글', href: '/pain/' },
    ],
    note: '석회 정도, 골절, 종양이 있는 부위 등 자극이 맞지 않는 경우가 있어, 받기 전 진료로 확인합니다.',
  },
